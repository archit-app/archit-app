...
Usage:
    from floorplan.io.json_schema import building_to_json, building_from_json
...
from floorplan.elements.opening import Frame, Opening, OpeningKind, SwingGeometry
...
def building_to_dict(building: Building) -> dict[str, Any]:
    ...
    return {
        "_floorplan_version": FORMAT_VERSION,
        "metadata": {
...
def save_building(building: Building, path: str, indent: int = 2) -> None:
    """Write a Building to a .floorplan.json file."""
